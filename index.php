...
<head>
	...
	<!-- SEO Stuff -->
	<meta name="keywords" content="pacman, html5, html-game, html-canvas, js-game" />
	...
	<meta property="og:image" content="img/Icon-200x200.png"/>
    <meta property="og:title" content="Pacman in HTML5" />
    ...
    <meta property="og:url" content="https://github.com/SunPodder/pacman" />
    <meta property="og:site_name" content="Pacman in HTML5" />
	<meta property="og:locale" content="en_US" />

	<!-- site icons -->
	<link rel="shortcut icon" href="img/Icon-130x130.png" />
	<link rel="apple-touch-icon" href="img/Icon-130x130.png" />
    <meta property="og:image" content="img/Icon-130x130.png"/>
	...
	<div>
		...
		<p>
			<ol id="highscore-list">
				<?php
				  $data = json_decode(file_get_contents("data/highscores.json"));
				  if(count($data) < 5){
				    $max = count($data);
				  }else{
				    $max = 5;
				  ...
				  $i = 0;
				  while($i < $max){
				    echo "<li><span>".$data[$i]->name."</span><span class='pull-right'>".$data[$i]->score."</span></li>";
				    $i+=1;
				  }
				?>
			</ol>
...
<div class="content" id="instructions-content">
	...
	<div>
		...
		<div>
			...
			Clyde will stay in the ghost house until pacman has eaten at least 2/3 of all pills. His home is the bottom left corner.
		</div>
...
<div class="content" id="info-content">
	...
	<div>
		...
		<p>Pacman is Open Source, written by <a href="https://github.com/SunPodder">Sun Podder</a>. You can get the code on <a href="https://github.com/SunPodder/pacman" target="_blank">github</a>.</p>
	</div>
</div>
